...
import com.open.teachermanager.factory.bean.annotation.ImageField;
import com.open.teachermanager.factory.bean.annotation.TextField;
...
//                                    packageName), vh.ivs.get(i));
                ...
                if (id != 0) {//本地图片存在
                    ...
                    if (displayImageOptions == null) {
                        vh.findImgs.get(fieldName).setImageResource(R.mipmap.icon_default);
                    } else {
                        ImageLoader.getInstance().displayImage("", vh.findImgs.get(fieldName), displayImageOptions);
                    }
                }
            } else {
                if (displayImageOptions == null)
