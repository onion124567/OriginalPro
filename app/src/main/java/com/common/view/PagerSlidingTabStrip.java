...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int tabPadding = 21;
    private int dividerWidth = 20;

    private int tabTextSize = 16;
    private int tabTextColor = 0x80FFFFFF;
...
//TODO Mark
        canvas.drawRect(lineLeft + lineOffset, height - indicatorHeight, lineRight - lineOffset, height,
                rectPaint);
    ...
    private class PageListener implements OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            ...
            // 设置头部底部显示
//            ((FastShopIndexActivity) pager.getContext()).  scroll4Visable(true);
//			if (pager.getCurrentItem() != 0) {
//				if(slidingMenu!=null)
//				slidingMenu.setTouchModeAbove(SlidingMenu.TOUCHMODE_NONE);
